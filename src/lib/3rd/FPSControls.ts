// @ts-nocheck
// taken from https://github.com/mrdoob/three.js/blob/5da9a7045dfe4a3ee6d5db431ba4bce69c811749/examples/jsm/controls/FirstPersonControls.js
// modified to move based on on difference between mouse position during movement
import {
    MathUtils,
    Spherical,
    Vector3
